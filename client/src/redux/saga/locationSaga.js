...
function* getLocationSaga(action) {
  ...
  const locationName =
    localityInfo[4]?.name === undefined
      ? `P.${localityInfo[3].name}, Q.${localityInfo[2].name}, TP.${localityInfo[1].name}`
      : `P.${localityInfo[4].name}, Q.${localityInfo[3].name}, TP.${localityInfo[2].name}`;
